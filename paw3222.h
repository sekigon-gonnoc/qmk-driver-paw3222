...
#ifndef PAW3222_SCLK_PIN
#    ifdef POINTING_DEVICE_SCLK_PIN
#        define PAW3222_SCLK_PIN POINTING_DEVICE_SCLK_PIN
#    else
#        error "No clock pin defined -- missing POINTING_DEVICE_SCLK_PIN or PAW3222_SCLK_PIN"
#    endif
#endif
#ifndef PAW3222_SDIO_PIN
#    ifdef POINTING_DEVICE_SDIO_PIN
#        define PAW3222_SDIO_PIN POINTING_DEVICE_SDIO_PIN
#    else
#        error "No data pin defined -- missing POINTING_DEVICE_SDIO_PIN or PAW3222_SDIO_PIN"
#    endif
#endif
...
#    else
#        error "No data pin defined -- missing POINTING_DEVICE_CS_PIN or PAW3222_CS_PIN"
#    endif
#endif
